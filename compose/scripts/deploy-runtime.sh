...
SEQUENCER_ADAPTIVE_SMALL_TIMEOUT_MS="${SEQUENCER_ADAPTIVE_SMALL_TIMEOUT_MS:-500}"
SEQUENCER_ADAPTIVE_MEDIUM_TIMEOUT_MS="${SEQUENCER_ADAPTIVE_MEDIUM_TIMEOUT_MS:-1000}"
SEQUENCER_ADAPTIVE_LARGE_TIMEOUT_MS="${SEQUENCER_ADAPTIVE_LARGE_TIMEOUT_MS:-2000}"
...
adaptive_small_timeout_ms = ${SEQUENCER_ADAPTIVE_SMALL_TIMEOUT_MS}
adaptive_medium_timeout_ms = ${SEQUENCER_ADAPTIVE_MEDIUM_TIMEOUT_MS}
adaptive_large_timeout_ms = ${SEQUENCER_ADAPTIVE_LARGE_TIMEOUT_MS}
