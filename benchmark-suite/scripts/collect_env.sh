...
cat > "$METRICS_ROOT/run_metadata.json" <<EOF
{
  ...
  "config_snapshot": {
    ...
    "adaptive_small_timeout_ms": "${ADAPTIVE_SMALL_TIMEOUT_MS:-unknown}",
    "adaptive_medium_timeout_ms": "${ADAPTIVE_MEDIUM_TIMEOUT_MS:-unknown}",
    "adaptive_large_timeout_ms": "${ADAPTIVE_LARGE_TIMEOUT_MS:-unknown}",
