...
export ADAPTIVE_SMALL_TIMEOUT_MS=${ADAPTIVE_SMALL_TIMEOUT_MS:-500}
export ADAPTIVE_MEDIUM_TIMEOUT_MS=${ADAPTIVE_MEDIUM_TIMEOUT_MS:-1000}
export ADAPTIVE_LARGE_TIMEOUT_MS=${ADAPTIVE_LARGE_TIMEOUT_MS:-2000}
...
restart_docker_stack_for_run() {
    ...
    (
        ...
        SEQUENCER_ADAPTIVE_SMALL_TIMEOUT_MS="$ADAPTIVE_SMALL_TIMEOUT_MS" \
        SEQUENCER_ADAPTIVE_MEDIUM_TIMEOUT_MS="$ADAPTIVE_MEDIUM_TIMEOUT_MS" \
        SEQUENCER_ADAPTIVE_LARGE_TIMEOUT_MS="$ADAPTIVE_LARGE_TIMEOUT_MS" \
