...
interface MailboxFacetTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getL2GasPrice(uint256)": FunctionFragment;
    ...
    "setFeeParams(tuple)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "getL2GasPrice",
    values: [BigNumberish]
  ): string;
...
export class MailboxFacetTest extends Contract {
  ...
  interface: MailboxFacetTestInterface;
  ...
  functions: {
    ...
    getL2GasPrice(
      _l1GasPrice: BigNumberish,
      overrides?: CallOverrides
    ): Promise<{
      0: BigNumber;
    }>;

    "getL2GasPrice(uint256)"(
      _l1GasPrice: BigNumberish,
      overrides?: CallOverrides
    ): Promise<{
      0: BigNumber;
    ...
    "setFeeParams((uint8,uint32,uint32,uint32,uint32,uint64))"(
      _feeParams: {
        pubdataPricingMode: BigNumberish;
        batchOverheadL1Gas: BigNumberish;
        maxPubdataPerBatch: BigNumberish;
