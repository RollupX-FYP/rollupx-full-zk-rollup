...
import type { IZKChain } from "./IZKChain";

export class IZKChainFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IZKChain {
    return new Contract(address, _abi, signerOrProvider) as IZKChain;
  }
}
...
const _abi = [
  ...
  {
    inputs: [],
    name: "getL2EvmEmulatorBytecodeHash",
    outputs: [
      {
        internalType: "bytes32",
        name: "",
  ...
  {
    inputs: [],
    name: "getPriorityTreeStartIndex",
    outputs: [
      {
        internalType: "uint256",
        name: "",
