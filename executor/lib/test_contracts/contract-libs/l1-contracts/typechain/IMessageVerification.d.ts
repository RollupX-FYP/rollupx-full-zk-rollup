...
interface IMessageVerificationInterface extends ethers.utils.Interface {
  functions: {
...
export class IMessageVerification extends Contract {
  ...
  interface: IMessageVerificationInterface;
