...
interface L2SharedBridgeLegacyInterface extends ethers.utils.Interface {
  functions: {
...
export class L2SharedBridgeLegacy extends Contract {
  ...
  interface: L2SharedBridgeLegacyInterface;
