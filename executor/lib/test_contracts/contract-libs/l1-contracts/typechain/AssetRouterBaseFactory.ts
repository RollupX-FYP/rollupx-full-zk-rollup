...
import type { AssetRouterBase } from "./AssetRouterBase";

export class AssetRouterBaseFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AssetRouterBase {
    return new Contract(address, _abi, signerOrProvider) as AssetRouterBase;
  }
}
