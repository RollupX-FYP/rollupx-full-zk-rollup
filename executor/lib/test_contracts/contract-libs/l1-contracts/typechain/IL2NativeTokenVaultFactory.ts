...
import type { IL2NativeTokenVault } from "./IL2NativeTokenVault";

export class IL2NativeTokenVaultFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IL2NativeTokenVault {
    return new Contract(address, _abi, signerOrProvider) as IL2NativeTokenVault;
  }
}
