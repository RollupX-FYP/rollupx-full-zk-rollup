...
interface DummyZKChainInterface extends ethers.utils.Interface {
  functions: {
    ...
    "genesisUpgrade(address,bytes,bytes[])": FunctionFragment;
    "getBridgeHubAddress()": FunctionFragment;
    "getEraChainId()": FunctionFragment;
    ...
    "setBaseTokenGasMultiplierPrice(uint128,uint128)": FunctionFragment;
    "setBridgeHubAddress(address)": FunctionFragment;
    "setFeeParams()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "getBridgeHubAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getEraChainId",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setBaseTokenGasMultiplierPrice",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setBridgeHubAddress",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class DummyZKChain extends Contract {
  ...
  interface: DummyZKChainInterface;
  ...
  functions: {
    ...
    "genesisUpgrade(address,bytes,bytes[])"(
      _l1GenesisUpgrade: string,
      _forceDeploymentData: BytesLike,
      _factoryDeps: BytesLike[],
      overrides?: Overrides
    ...
    getBridgeHubAddress(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
    ...
    getEraChainId(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
    ...
    setBaseTokenGasMultiplierPrice(
      nominator: BigNumberish,
      denominator: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "setBaseTokenGasMultiplierPrice(uint128,uint128)"(
      nominator: BigNumberish,
      denominator: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
    ...
    "setBridgeHubAddress(address)"(
      bridgeHubAddress: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    setFeeParams(overrides?: Overrides): Promise<ContractTransaction>;
  ...
  getBridgeHubAddress(overrides?: CallOverrides): Promise<string>;

  "getBridgeHubAddress()"(overrides?: CallOverrides): Promise<string>;

  getEraChainId(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    setFeeParams(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    getBridgeHubAddress(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    setFeeParams(overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getEraChainId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    setFeeParams(overrides?: Overrides): Promise<PopulatedTransaction>;
