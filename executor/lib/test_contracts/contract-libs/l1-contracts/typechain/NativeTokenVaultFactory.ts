...
import type { NativeTokenVault } from "./NativeTokenVault";

export class NativeTokenVaultFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): NativeTokenVault {
    return new Contract(address, _abi, signerOrProvider) as NativeTokenVault;
  }
}
