...
interface GatewayUpgradeInterface extends ethers.utils.Interface {
  functions: {
    "THIS_ADDRESS()": FunctionFragment;
    "upgrade(tuple)": FunctionFragment;
    "upgradeExternal(tuple)": FunctionFragment;
  };

  encodeFunctionData(
    functionFragment: "THIS_ADDRESS",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class GatewayUpgrade extends Contract {
  ...
  interface: GatewayUpgradeInterface;

  functions: {
    THIS_ADDRESS(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  THIS_ADDRESS(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    THIS_ADDRESS(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    THIS_ADDRESS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
