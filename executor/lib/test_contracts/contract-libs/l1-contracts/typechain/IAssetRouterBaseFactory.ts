...
import type { IAssetRouterBase } from "./IAssetRouterBase";

export class IAssetRouterBaseFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IAssetRouterBase {
    return new Contract(address, _abi, signerOrProvider) as IAssetRouterBase;
  }
}
