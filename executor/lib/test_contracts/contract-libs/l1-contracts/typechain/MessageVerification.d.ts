...
interface MessageVerificationInterface extends ethers.utils.Interface {
  functions: {
...
export class MessageVerification extends Contract {
  ...
  interface: MessageVerificationInterface;
