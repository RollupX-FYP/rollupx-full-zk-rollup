...
interface L1NullifierDevInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setL2LegacySharedBridge(uint256,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setL2LegacySharedBridge",
    values: [BigNumberish, string]
  ): string;
  encodeFunctionData(
...
export class L1NullifierDev extends Contract {
  ...
  interface: L1NullifierDevInterface;
  ...
  functions: {
    ...
    setL2LegacySharedBridge(
      _chainId: BigNumberish,
      _l2Bridge: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "setL2LegacySharedBridge(uint256,address)"(
      _chainId: BigNumberish,
      _l2Bridge: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
