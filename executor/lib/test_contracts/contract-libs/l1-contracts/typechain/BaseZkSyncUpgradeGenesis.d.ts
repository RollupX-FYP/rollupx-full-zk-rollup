...
interface BaseZkSyncUpgradeGenesisInterface extends ethers.utils.Interface {
  functions: {
...
export class BaseZkSyncUpgradeGenesis extends Contract {
  ...
  interface: BaseZkSyncUpgradeGenesisInterface;
