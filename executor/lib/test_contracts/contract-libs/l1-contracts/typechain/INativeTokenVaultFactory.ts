...
import type { INativeTokenVault } from "./INativeTokenVault";

export class INativeTokenVaultFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): INativeTokenVault {
    return new Contract(address, _abi, signerOrProvider) as INativeTokenVault;
  }
}
