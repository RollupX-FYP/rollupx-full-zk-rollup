...
import type { IL1NativeTokenVault } from "./IL1NativeTokenVault";

export class IL1NativeTokenVaultFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IL1NativeTokenVault {
    return new Contract(address, _abi, signerOrProvider) as IL1NativeTokenVault;
  }
}
