...
interface DummyL1ERC20BridgeInterface extends ethers.utils.Interface {
  functions: {
    "ERA_CHAIN_ID()": FunctionFragment;
    "L1_ASSET_ROUTER()": FunctionFragment;
    "L1_NATIVE_TOKEN_VAULT()": FunctionFragment;
    ...
    "setValues(address,address,bytes32)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "L1_NATIVE_TOKEN_VAULT",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class DummyL1ERC20Bridge extends Contract {
  ...
  interface: DummyL1ERC20BridgeInterface;
  ...
  functions: {
    ...
    L1_NATIVE_TOKEN_VAULT(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  L1_NATIVE_TOKEN_VAULT(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    L1_NATIVE_TOKEN_VAULT(overrides?: CallOverrides): Promise<BigNumber>;
