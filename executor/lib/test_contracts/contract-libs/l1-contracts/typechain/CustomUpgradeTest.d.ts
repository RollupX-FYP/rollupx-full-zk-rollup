...
interface CustomUpgradeTestInterface extends ethers.utils.Interface {
  functions: {
...
export class CustomUpgradeTest extends Contract {
  ...
  interface: CustomUpgradeTestInterface;
