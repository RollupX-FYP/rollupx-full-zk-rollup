...
\begin{itemize}
    ...
    \item \textbf{Sequencing Policies:} The rules used by the sequencer to order transactions in the mempool. We test standard First-Come-First-Served (FCFS), FeePriority, FairBFT and TimeBoost ~\cite{timeboost_docs}
