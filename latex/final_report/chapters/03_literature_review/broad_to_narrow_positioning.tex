...
The previous section presents the broad taxonomy of blockchain scalability solutions. However, the scope of this report is narrower than the complete scalability landscape. Figure~\ref{fig:blockchain_scalability_taxonomy} therefore shows the specific broad-to-narrow research path followed in this project. It connects the general blockchain scalability literature to the particular ZK-rollup bottlenecks evaluated by the proposed RollupX benchmarking framework.
