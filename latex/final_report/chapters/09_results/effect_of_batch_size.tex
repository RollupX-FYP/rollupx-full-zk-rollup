...
\begin{figure}[H]
    ...
    \caption{Effect of batch size on latency and cost.}
...
Figure~\ref{fig:batch_vs_latency_cost} illustrates the relationship between batch size, latency, and cost per transaction.
