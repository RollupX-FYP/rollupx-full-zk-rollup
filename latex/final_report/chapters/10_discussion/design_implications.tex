...
\begin{itemize}
    ...
    \item \textbf{Preserve Nonce Ordering via Account Grouping:} The global reordering of transactions based on fees/sizes without checking nonces breaks execution. The modular scheduler preserves nonce ordering by grouping transactions by account and sorting by nonce before applying sorting heuristics. Sequencers must treat transaction dependency as a first-class scheduling constraint.
