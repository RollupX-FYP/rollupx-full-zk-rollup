...
The challenge of improving these metrics is often framed as the Blockchain Trilemma \citep{fu2024trilemma}. It suggests that a blockchain architecture can only achieve two out of three desirable properties:
\begin{enumerate}
