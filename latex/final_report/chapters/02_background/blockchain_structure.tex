...
A blockchain is a distributed, append-only ledger that maintains a continuously growing list of records, called blocks, securely linked together using cryptography. Each block contains a cryptographic hash of the previous block, a timestamp, and transaction data \citep{nakamoto2008bitcoin}. This structure ensures data integrity and immutability. 
