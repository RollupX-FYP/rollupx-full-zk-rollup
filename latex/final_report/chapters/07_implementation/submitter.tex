...
\begin{itemize}
    ...
    \item \textbf{Output:} Broadcasts transactions to the L1 Hardhat node via \code{eth\_sendRawTransaction} and records critical latency and gas metrics to \texttt{submitter\_metrics.json}.
\end{itemize}
