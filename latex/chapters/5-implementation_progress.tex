...
A dynamic batch-size controller was designed as an extension to the sequencer. The current implementation can be integrated into the batching layer as a policy module, while the present evaluation uses the model to guide configuration selection and interpret batching trade-offs.
\input{chapters/Implementation_Progress/sequencer}

\subsection{Executor}
\input{chapters/Implementation_Progress/executor}

\subsection{Submitter}
\input{chapters/Implementation_Progress/submitter}

\subsection{Prover}
\input{chapters/Implementation_Progress/prover}

\subsection{Smart Contracts}
\input{chapters/Implementation_Progress/smart_contracts}
