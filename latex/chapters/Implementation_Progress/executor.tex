...
\begin{itemize}[leftmargin=*]
    \item \textbf{Transfer}: Direct state mutation via \texttt{StateRepository} (debit sender, credit recipient). The executor is a simplified state-transition engine for transfer-style workloads and Merkle state updates. It is not a full EVM or zkEVM execution environment.
\end{itemize}
