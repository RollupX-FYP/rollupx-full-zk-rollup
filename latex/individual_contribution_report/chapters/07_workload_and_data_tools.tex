...
The workload generator and data tools form the two ends of the benchmark process. The evaluation phase required synthesizing distributed outputs. My pipeline logic transforms: Raw service logs $\rightarrow$ aggregation $\rightarrow$ statistics $\rightarrow$ plots $\rightarrow$ final report evaluation.
