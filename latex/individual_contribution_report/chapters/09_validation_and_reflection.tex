...
\texttt{bed3de7} &
\path{sequencer/src/api/server.rs} &
Normalized address strings using \texttt{strip\_prefix("0x")} before hexadecimal decoding. This allowed both prefixed and non-prefixed Ethereum-style addresses to be accepted by the Sequencer parsing path. \\ \hline
