...
METRICS = [
    ...
    ("avg_blob_utilization", "Avg Blob Utilization"),
    ("avg_soft_commit_ms",   "Avg Soft Commit (ms)"),
    ("avg_hard_finality_ms", "Avg Hard Finality (ms)"),
    ("avg_finality_gain_ms", "Avg Finality Gain (ms)"),
    ("avg_total_cost_wei",   "Avg Total Cost (wei)"),
    ("avg_cost_per_tx_wei",  "Avg Cost/tx (wei)"),
