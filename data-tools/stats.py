...
METRICS = [
    ...
    ("avg_execution_ms",     "Avg Execute (ms)"),
    ("avg_executor_total_ms","Avg Executor Total (ms)"),
    ("avg_sealed_to_proved_ms", "Avg Sealed→Proved (ms)"),
    ("avg_sealed_to_published_ms", "Avg Sealed→Published (ms)"),
    ("avg_submit_l1_ms",     "Avg Submit→Receipt (ms)"),
    ...
    ("avg_sealed_tx_count",  "Avg Sealed Tx Count"),
    ("avg_sealed_gas_limit_sum", "Avg Sealed Gas Limit Sum"),
    ("avg_proof_size_bytes", "Avg Proof Size (B)"),
    ("avg_journal_size_bytes", "Avg Journal Size (B)"),
    ("avg_proof_bytes",      "Avg Submitted Proof (B)"),
    ("avg_da_meta_bytes",    "Avg DA Meta (B)"),
