        ...
        row.update(
            {
                ...
                "adaptive_small_timeout_ms": _to_float(cfg.get("adaptive_small_timeout_ms")),
                "adaptive_medium_timeout_ms": _to_float(cfg.get("adaptive_medium_timeout_ms")),
                "adaptive_large_timeout_ms": _to_float(cfg.get("adaptive_large_timeout_ms")),
